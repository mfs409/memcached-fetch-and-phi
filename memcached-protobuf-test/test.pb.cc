...
void protobuf_AssignDesc_test_2eproto() {
  ...
  static const int AddressBook_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AddressBook, id_),
...
void protobuf_AddDesc_test_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\ntest.proto\022\004test\"\337\001\n\006Person\022\n\n\002id\030\001 \002("
    "\005\022\014\n\004name\030\002 \002(\t\022\r\n\005email\030\003 \001(\t\022\'\n\005phone\030"
    "\004 \003(\0132\030.test.Person.PhoneNumber\032I\n\013Phone"
    "Number\022\016\n\006number\030\001 \002(\003\022*\n\004type\030\002 \001(\0162\026.t"
    "est.Person.PhoneType:\004HOME\"8\n\tPhoneType\022"
    "\n\n\006MOBILE\020\000\022\010\n\004WORK\020\001\022\010\n\004HOME\020\002\022\013\n\007PRIVA"
    "TE\020\003\"S\n\013AddressBook\022\n\n\002id\030\001 \002(\005\022\033\n\005owner"
    "\030\002 \002(\0132\014.test.Person\022\033\n\005entry\030\003 \003(\0132\014.te"
    "st.Person", 329);
...
const Person_PhoneType Person::PRIVATE;
...
#ifndef _MSC_VER
const int AddressBook::kIdFieldNumber;
...
void AddressBook::InitAsDefaultInstance() {
  owner_ = const_cast< ::test::Person*>(&::test::Person::default_instance());
}
...
void AddressBook::MergeFrom(const AddressBook& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_owner()) {
      mutable_owner()->::test::Person::MergeFrom(from.owner());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
