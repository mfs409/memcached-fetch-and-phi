...
namespace google_2fprotobuf_2funittest_2eproto {
...
void protobuf_AddDesc_google_2fprotobuf_2funittest_2eproto() {
  ...
  already_here = true;
  if (google_2fprotobuf_2funittest_2eproto::already_here) return;
  google_2fprotobuf_2funittest_2eproto:: already_here = true;
